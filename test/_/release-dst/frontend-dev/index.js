...
(function () {
  ...
  var other_mod = function other_mod() {
    console.log('other mod');
  };

  var throttle = function throttle(fn) {
    var timing = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200;
    ...
    return function () {
      ...
      if (!timer) {
        timer = setTimeout(function (e) {
          fn.apply(_this, args);timer = false;
        }, timing);
      }
    };
  };
  ...
  var template = function template(locals) {
    var pug_html = "",
      ...
      var locals_for_with = locals || {};(function (data) {
        pug_mixins["Mixin"] = pug_interp = function pug_interp() {
